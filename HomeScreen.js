       ...
       <TouchableOpacity style={styles.btn}>
        ...
        <View style={styles.contentContainer}>
          <View style={styles.welcomeDiv}>
            ...
            <TouchableOpacity style = {styles.border}>
            <Image style = {{marginTop: 15, marginLeft: 10, alignSelf: 'center', height: 79.5, width:79.5}} source = {require('../assets/Diagnosis.png')}/>
            <Text style = {{marginTop: 2, marginLeft:25 , fontSize: 15}}> Diagnosis </Text>
            </TouchableOpacity>
            </View>
          </View>
        </View>
