      ...
      >
        <TouchableOpacity style={styles.btn}>
          <Image
            ...
            style={{ height: 17, width: 38.5, marginLeft: 20, marginTop: 30 }}
          />
        </TouchableOpacity>
          ...
          <View style={styles.welcomeDiv}>
            ...
            >
              ...
              <View style={{ flex: 1, flexDirection: "row" }}>
                <Image
                  style={{ marginLeft: 20, height: 94, width: 90 }}
                  source={require("../assets/shot.png")}
                />
                <Image
                  style={{ marginLeft: 50, height: 100, width: 90 }}
            ...
            <View style={{ flex: 1, flexDirection: "row" }}>
              <TouchableOpacity style={styles.border}>
                <Image
                  style={{ alignSelf: "center", height: 97.3, width: 84.6 }}
              ...
              <TouchableOpacity style={styles.border}>
                ...
                />
                <Text style={{ marginTop: 2, marginLeft: 15, fontSize: 15 }}>
                  {" "}
                  Consultation{" "}
                </Text>
              </TouchableOpacity>
